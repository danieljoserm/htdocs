...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2018 a las 07:14:52
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `retrieve_orders` ()  NO SQL
BEGIN
SELECT
producto.nombre,pedido.id_pedido,pedido_detalle.cantidad,pedido.id_restaurante
FROM
pedido
INNER JOIN
pedido_detalle
...
INSERT INTO `pedido` (`id_pedido`, `id_restaurante`, `id_usuario`, `estado`) VALUES
(152, 1, 1, b'0'),
(153, 2, 1, b'0');
